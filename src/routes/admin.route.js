...
adminRoute.delete('/media_category/:id', authenticateAdmin, deleteMediaCategory);
...
adminRoute.patch('/media_category/:cat_id/add/:media_id', authenticateAdmin, addMediaToCategory);
adminRoute.patch('/media_category/:cat_id/remove/:media_id', authenticateAdmin, removeMediaFromCategory);

//---------- banner --------
adminRoute.get('/banners', authenticateAdmin, getBanners);
adminRoute.get('/banners/:id', authenticateAdmin, getBanner);
